  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-fade-in">
      ...
      {!completedReport ? (
        ...
        <div className="bg-slate-900 border border-emerald-500/40 rounded-3xl p-8 space-y-8 shadow-2xl animate-fade-in">
          ...
          {completedReport.explorerUrl && (
            <div className="p-4 rounded-2xl bg-gradient-to-r from-teal-950/40 to-slate-950 border border-teal-500/30 flex items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400 font-mono truncate max-w-xs">{completedReport.txHash}</p>
                </div>
              </div>
              <a
                ...
                className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-teal-500/20 hover:bg-teal-500/30 text-teal-300 font-bold text-xs border border-teal-500/30 transition-all"
              >
                <ExternalLink className="w-3 h-3" />
